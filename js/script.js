...
const config = {
    serverInfo: {
        ...
        serverName: "The Claw Club", /*Server name*/
        serverIp: "The Claw Club", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1478551699261227130" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
